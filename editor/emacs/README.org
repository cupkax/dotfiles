...
- [[#package-management][Package Management]]
  ...
  - [[#configure-packxage-manager][Configure Packxage Manager]]
...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (24528 49000 411383 0) :init (24528 49000 411378 0) :config (24528 49000 411371 0) :config-secs (0 0 12304 0) :init-secs (0 0 12313 0) :use-package-secs (0 0 12344 0)))
